...
@interface AKRequest ()
@property (nonatomic,readwrite) AKRequestState state;
...
+ (AKRequest *)getRequestWithParams:(NSMutableDictionary *) params
  ...
  AKRequest* request = [[[AKRequest alloc] init] autorelease];
...
- (void)connect {
  ...
  self.state = kAKRequestStateLoading;
...
- (void)connectionDidFinishLoading:(NSURLConnection *)connection {
  ...
  self.connection = nil;
  self.state = kAKRequestStateComplete;
}
